...
sys.path.append('.')
import torch
import PainAssessment.PainAssessmentCNN.face_alignment as FAN
from PainAssessment.PainAssessmentCNN.models.comparative_model import ConvNetOrdinalLateFusion
import numpy as np
import cv2
